    ...
    <div class="filter_body">
      ...
      <div class="filterComp">
        ...
        <button type="button"
          ...
          aria-expanded="true"
          :aria-label="ariaExpanded ? '펼치기' : '접기'"
        >
          ...
          <ul class="filterComp_list">
            ...
            >
              <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label" for="filter2-1">
                  <span>샘플라벨
      ...
      <div class="filterComp">
        ...
        >
          <h3 class="tit">샘플타이틀</h3>
          <svg aria-hidden="true" focusable="false" class="icoSvg stroke i_s20 ico_arr_right">
            <use xlink:href="@/assets/images/sp_svg.svg#ico_arrow" />
          </svg>
        </button>
