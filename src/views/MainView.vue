    ...
    <main>
      ...
      <div class="container">
        <div class="content">
          ...
          <!-- 주요항목 설정 -->
          <div class="douSet_area">
            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="81" fill="none" aria-label="" role="img" focusable="false">
            ...
            <p class="tit">주요항목 설정이 없습니다.</p>
            <p class="txt">주요항목을 설정하시면 항목을 한 눈에 보실 수 있습니다.</p>
            <button type="button" class="button primary lg" data-toggle="modal" data-target="#modal_documentSet">주요항목 설정</button>
          </div>
          <!-- //주요항목 설정 -->
